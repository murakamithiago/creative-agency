    ...
    return (
        <section className="relative overflow-hidden pb-24 pt-40 md:pb-32 md:pt-52">
            ...
            <div className="absolute inset-0 -z-10">
                ...
                <div className="absolute left-[20%] top-[-20%] h-[400px] w-[400px] rounded-full bg-gradient-to-br from-violet-100/20 to-indigo-50/20 blur-3xl" />
                <div className="absolute bottom-[-15%] right-[10%] h-[350px] w-[350px] rounded-full bg-gradient-to-tl from-blue-50/25 to-indigo-50/15 blur-3xl" />
            </div>
            ...
            <div className="mx-auto max-w-7xl px-6">
                <div className="max-w-4xl">
                    ...
                    >
                        ...
                        engineering come together to create something exceptional.
                    </motion.p>
                </div>
